...
import {
    ShieldCheck, LogIn, Copy, Check, Terminal, WifiOff,
    LayoutGrid, Users, Map, Mail, ArrowLeft
} from 'lucide-react'
...
const ADMIN_NAV = [
    ...
    { to: '/admin/itineraries', label: 'Itineraries', icon: Map },
...
export default function AdminLayout() {
                ...
                <div className="wandermap-card rounded-3xl border border-slate-200 overflow-hidden">
                    ...
                    <ol className="p-6 space-y-4 text-xs text-slate-700 leading-relaxed">
                        ...
                        <li>
                            ...
                            Sign out and back in on WanderSync. The "Control Tower" pages will unlock automatically.
                        </li>
                    </ol>
                </div>
            </div>
    ...
    // Is an admin — show the multi-page Control Tower shell
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <nav className="lg:col-span-3">
                    <div className="wandermap-card rounded-2xl border border-slate-200/90 p-2 flex lg:flex-col gap-1.5 overflow-x-auto">
                        {ADMIN_NAV.map(({ to, label, icon: Icon, end }) => (
                            <NavLink
                                ...
                                className={({ isActive }) =>
                                    `flex items-center gap-2.5 px-4 py-2.5 rounded-xl text-xs font-bold transition-all shrink-0 ${isActive
